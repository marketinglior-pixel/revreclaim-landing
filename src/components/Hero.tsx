    ...
    <section ref={sectionRef} className="relative overflow-hidden pt-32 pb-20 md:pt-44 md:pb-32">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center animate-fade-in-up animate-delay-400">
          ...
          <span className="text-sm text-[#999]">Free forever. No credit card. No sales call. Report in 90 seconds.</span>
        </div>

        {/* Guarantee badge — with "because" reason (Hormozi Hack #4) */}
        <div className="mt-8 inline-flex flex-col items-center gap-1">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#10B981]/20 bg-[#10B981]/5 px-5 py-2.5">
            ...
            <span className="text-sm text-[#999]">or every paid plan is free</span>
          </div>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 border-t border-[#1A1A1A] pt-8">
          <div className="text-center">
            ...
            <div className="text-xs text-[#999]">Revenue leaks found</div>
          </div>
          <div className="hidden h-8 w-px bg-[#222] sm:block" />
          <div className="text-center">
            <div className="text-2xl font-bold"><ScanCounter /></div>
            <div className="text-xs text-[#999]">Accounts scanned</div>
          </div>
          <div className="hidden h-8 w-px bg-[#222] sm:block" />
          <div className="text-center">
            <div className="text-2xl font-bold text-white">94%</div>
            <div className="text-xs text-[#999]">Had at least 1 leak</div>
          </div>
          <div className="hidden h-8 w-px bg-[#222] sm:block" />
          <div className="text-center">
