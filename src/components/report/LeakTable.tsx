    ...
    <div>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {/* Severity filter */}
          <div className="flex gap-1 bg-[#111111] border border-[#2A2A2A] rounded-lg p-1">
          ...
          {existingTypes.length > 1 && (
            <select
              ...
              className="px-3 py-1.5 text-xs bg-[#111111] border border-[#2A2A2A] rounded-lg text-[#ccc] focus:border-[#10B981] focus:outline-none"
            >
